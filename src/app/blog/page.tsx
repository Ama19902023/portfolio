...
export const metadata: Metadata = {
  title: 'Blog — Actuarial Science, AI and Quantitative Finance',
  description: 'Practical articles on IFRS 17, Solvency II, SST, ALM, LLM fine-tuning and algo trading — written by a senior actuary with 11 years of production experience.',
}
    ...
    <main style={{minHeight: '100vh', backgroundColor: '#0a0a0a', padding: '120px 24px 96px'}}>
      <div style={{maxWidth: '800px', margin: '0 auto'}}>
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px'}}>
          ...
          <a href="/fr/blog" style={{color: '#00ff88', textDecoration: 'none', fontSize: '14px', border: '1px solid #00ff88', padding: '6px 16px', borderRadius: '999px'}}>FR</a>
        </div>
